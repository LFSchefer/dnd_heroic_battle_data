...
CREATE TABLE armor_types (
	...
	CONSTRAINT armor_classes_pkey PRIMARY KEY (armor_type),
);

CREATE TABLE conditions (
	condition_name varchar(50) NOT NULL,
	description varchar(1500),
	CONSTRAINT conditions_pkey PRIMARY KEY (condition_name),
);

CREATE TABLE damage_types (
	damage_type_name varchar(50),
	description varchar(255),
	CONSTRAINT damage_type_pkey PRIMARY KEY (damage_type_name),
);

CREATE TABLE monster_types (
	type_name varchar(50) NOT NULL,
	CONSTRAINT monter_type_pkey PRIMARY KEY (type_name),
);

CREATE TABLE sizes (
	size_name varchar(50) NOT NULL,
	CONSTRAINT sizes_pkey PRIMARY KEY (size_name),
);

CREATE TABLE alignments (
	alignments_name varchar(50) NOT NULL,
	description varchar(255),
	CONSTRAINT alignments_pkey PRIMARY KEY (alignments_name),
);

CREATE TABLE languages (
	languages_name varchar(50) NOT NULL,
	CONSTRAINT langages_pkey PRIMARY KEY (languages_name),
);

CREATE TABLE special_abilities (
	special_ability_name varchar(50) NOT NULL,
	special_ability_description varchar(1500) NOT NULL,
	CONSTRAINT special_ability_pkey PRIMARY KEY (special_ability_name),
...
CREATE TABLE monster_models (
	...
	CONSTRAINT monter_pkey PRIMARY KEY (model_name),
...
CREATE TABLE monster_languages (
	...
	CONSTRAINT language_fkey FOREIGN KEY (language_id) REFERENCES languages(languages_name),
	CONSTRAINT monster_fkey FOREIGN KEY (monster_id) REFERENCES monster_models(model_name) ON DELETE CASCADE
);

CREATE TABLE monster_special_abilities (
	monster_id varchar NOT NULL,
	special_ability_id varchar NOT NULL,
	CONSTRAINT monster_special_ability_pkey PRIMARY KEY (monster_id,special_ability_id),
	CONSTRAINT special_ability_fkey FOREIGN KEY (special_ability_id) REFERENCES special_abilities(special_ability_name),
	CONSTRAINT monster_fkey FOREIGN KEY (monster_id) REFERENCES monster_models(model_name) ON DELETE CASCADE
);
...
CREATE TABLE monster_vulnerabilities (
	...
	CONSTRAINT vulnerability_fkey FOREIGN KEY (vulnerability_id) REFERENCES damage_types(damage_type_name),
	CONSTRAINT monster_fkey FOREIGN KEY (monster_id) REFERENCES monster_models(model_name) ON DELETE CASCADE
);

CREATE TABLE monster_resistances (
	resistance_id varchar NOT NULL,
	monster_id varchar NOT NULL,
	CONSTRAINT monster_resistances_pkey PRIMARY KEY (resistance_id,monster_id),
	CONSTRAINT resistance_fkey FOREIGN KEY (resistance_id) REFERENCES damage_types(damage_type_name),
	CONSTRAINT monster_fkey FOREIGN KEY (monster_id) REFERENCES monster_models(model_name) ON DELETE CASCADE
);

CREATE TABLE monster_imunities (
	imunity_id varchar NOT NULL,
	monster_id varchar NOT NULL,
	CONSTRAINT monster_imunity_pkey PRIMARY KEY (imunity_id,monster_id),
	CONSTRAINT imunity_fkey FOREIGN KEY (imunity_id) REFERENCES damage_types(damage_type_name),
	CONSTRAINT monster_fkey FOREIGN KEY (monster_id) REFERENCES monster_models(model_name) ON DELETE CASCADE 
);
...
CREATE TABLE monster_condition_immunities (
	...
	CONSTRAINT condition_imunity_fkey FOREIGN KEY (condition_id) REFERENCES conditions(condition_name),
	CONSTRAINT monster_fkey FOREIGN KEY (monster_id) REFERENCES monster_models(model_name) ON DELETE CASCADE
);
...
CREATE TABLE campaigns (
	...
	CONSTRAINT campaigns_pkey PRIMARY KEY (campaign_name),
	CONSTRAINT unique_campaign UNIQUE (campaign_name, user_id),
	CONSTRAINT user_fkey FOREIGN KEY (user_id) REFERENCES users(email) ON DELETE CASCADE
);
...
CREATE TABLE battles (
	...
	CONSTRAINT battle_pkey PRIMARY KEY (battle_name),
	CONSTRAINT battle_ukey UNIQUE (battle_name, campaign_id),
	CONSTRAINT campaing_fkey FOREIGN KEY (campaign_id) REFERENCES campaigns(campaign_name) ON DELETE CASCADE
);
...
CREATE TABLE monsters (
	...
	CONSTRAINT battle_monster_pkey PRIMARY KEY (monster_name),
	CONSTRAINT monster_fkey FOREIGN KEY (model_id) REFERENCES monster_models(model_name),
	CONSTRAINT battle_fkey FOREIGN KEY (battle_id) REFERENCES battles(battle_name) ON DELETE CASCADE
);